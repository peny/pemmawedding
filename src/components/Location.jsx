        ...
        <div className="location-content">
          ...
          <div className="location-details">
            ...
            <div className="location-card">
              ...
              <p className="card-text">
                Vi rekommenderar att ni bokar boende så snart som möjligt då det är högsäsong på Gotland! Alla hotell i Visby är i princip inom promenadavstånd till St. Nicolai.
              </p>
              <p className="card-text">
                <a 
